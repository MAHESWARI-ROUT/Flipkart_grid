    ...
    <div className={`rounded-xl border-2 ring-2 ${s.ring} ${s.bg} p-6 space-y-4`}>
      ...
      <div className="bg-black bg-opacity-30 rounded-lg p-3">
        ...
        <div className="w-full bg-gray-700 rounded-full h-2 mt-2">
          <div
            className={`h-2 rounded-full transition-all duration-700 ${
              result.road_closure_probability > 70 ? 'bg-red-500'
        ...
        <p className={`text-xs mt-1.5 ${
          result.road_closure_probability > 70 ? 'text-red-400'
      ...
      {hasFeatures && (
        <div className="bg-black bg-opacity-25 rounded-lg p-4 space-y-3 border border-gray-700">
          ...
          {/* Summary badge */}
          <div className={`mt-2 text-xs rounded-md px-3 py-2 flex items-center gap-2 ${
            (jf ?? 0) > 50 || (hd ?? 0) > 50
